# Landingpages canonical figure style contract
...
This contract affects all figures in the landingpages directory (snode.c, mqttsuite, aisuite, codexui, ...) not just to mqtt even only mqtt is mentioned in the text
