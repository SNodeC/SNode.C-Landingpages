...
% 17. If several connectors share one border, use the canonical distributed-port primitives. Port i of n is derived from the current border geometry at i/(n+1); figure sources never own attachment fractions or distances.
