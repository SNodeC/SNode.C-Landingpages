...
% ---------------------------------------------------------------------------
%
% Flat rendering is authoritative. Keep the elevation vocabulary available as
% no-ops so figures cannot silently introduce decorative shadows.
...
% ---------------------------------------------------------------------------
%
% Keep this key list paragraph-free: pgfkeys does not accept \par tokens inside
% \tikzset.
...
% ---------------------------------------------------------------------------
%
% Every directional connector is one continuous TikZ path whose arrowhead is
% attached to that same path. Off-axis routing is orthogonal by default.
